 ...
 *
 */
public class YotpoReviewsBeforeViewHandler implements BeforeViewHandler
{
	private final static Logger LOG = Logger.getLogger(YotpoReviewsBeforeViewHandler.class);
	...
	public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView)
	{
      ...
      if (shouldIntercept(path) && requestMethodMatches(request.getMethod()))
      {
      	...
      	modelAndView.addObject("isReviewEnabled", yotpoConfiguretion.getEnableReviews());
      }
	}
