 ...
 *  
 */
package com.yotpo.yotpoaddon.jalo;
...
import com.yotpo.yotpoaddon.constants.YotpoaddonConstants;



/**
 * This is the extension manager of the Yotpoaddon extension.
 */
public class YotpoaddonManager extends GeneratedYotpoaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YotpoaddonManager.class.getName());
	 ...
	 */
	public static YotpoaddonManager getInstance()
	{
		return (YotpoaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YotpoaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YotpoaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YotpoaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YotpoaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YotpoaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
