 ...
 * Created by haseeb
 */
public class YotpoExportDataEvent extends AbstractEvent
{
	private String code;
	...
	{
		return "YotpoExportDataEvent [code=" + code + ", site=" + site + ", previousJobStartTime=" + previousJobStartTime + "]";
	}
